        ...
        <div class="tp-banner" >
            <ul>
                <li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
                    {{ image("img/transparent.png", "alt" : "slidebg1", "data-bgfit" : "cover", "data-bgposition" : "left top", "data-bgrepeat" : "no-repeat") }}
                    <div class="tp-caption lfl fadeout hidden-xs"
                        ...
                        {{ image("img/freeze/Slides/hand-freeze.png") }}
                    </div>
                    ...
                    <div class="tp-caption lfl fadeout visible-xs"
                         ...
                         data-start="700"
                         data-easing="Power4.easeOut">
                        {{ image("img/freeze/iphone-freeze.png") }}
                    </div>
                ...
                <li data-transition="zoomout" data-slotamount="7" data-masterspeed="1000" >
                    ...
                    <div class="tp-caption lfb fadeout hidden-xs"
                         ...
                         data-start="700"
                         data-easing="Power4.easeOut">
                        {{ image("img/freeze/Slides/freeze-slide2.png") }}
                    </div>
                ...
                <li data-transition="zoomout" data-slotamount="7" data-masterspeed="1000" >
                    ...
                    <div class="tp-caption customin customout hidden-xs"
                         ...
                         data-start="700"
                         data-easing="Power4.easeOut">
                        {{ image("img/freeze/Slides/family-freeze.png") }}
                    </div>
